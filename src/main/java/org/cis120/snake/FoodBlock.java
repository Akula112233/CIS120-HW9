...
public class FoodBlock extends EdibleBlock {
    ...
    public static final int INIT_POS_X = GameCourt.COURT_WIDTH-(FoodBlock.SIZE / 2) - 100;
    public static final int INIT_POS_Y = GameCourt.COURT_HEIGHT-(FoodBlock.SIZE / 2) - 100;
